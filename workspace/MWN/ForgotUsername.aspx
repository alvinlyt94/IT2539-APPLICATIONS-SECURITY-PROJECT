<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotUsername.aspx.cs" Inherits="MWN.ForgotUsername" %>
            ...
            <div class="container1">
                <div id="breadcrumb">
                    <ul>
                        ...
                        <li>&#187;</li>
                        <li class="current"><a href="ForgotUsername.aspx">Forgot Username</a></li>
                    </ul>
                </div>
                <br />
                <br />
                ...
                <div class="box">
                    <h3>Forgot Username.<asp:Label ID="ToGoIn" runat="server" Text="0"></asp:Label></h3>
                    <b>Use the form below to retrieve your forgotten username.</b>
                    <br />
                    <br />
                    <h4>Email Address:</h4>

                    <asp:Label ID="EmailLabel" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#33CC33"></asp:Label>

                    <asp:TextBox ID="EmailTextField" TextMode="Email" placeholder="youremail@hotmail.com" title="youremail@hotmail.com" required="required" MaxLength="45" Columns="51" runat="server"></asp:TextBox>

                    <asp:Label ID="EmailValidateLabel" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#FF3300"></asp:Label>

                    <p><a href="ForgotEmail.aspx">Forgot your email address?</a></p>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="RetrieveUsername" runat="server" Text="Submit Email" OnClick="RetrieveUsername_Click" />
                </div>
            </div>
        </div>
