<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotEmail.aspx.cs" Inherits="MWN.ForgotEmail" %>
            ...
            <div class="container1">
                <div id="breadcrumb">
                    <ul>
                        ...
                        <li>&#187;</li>
                        <li class="current"><a href="ForgotEmail.aspx">Forgot Email Addess</a></li>
                    </ul>
                </div>
                <br />
                <br />
                ...
                <div class="box">
                    <h3>Forgot Email Addess.<asp:Label ID="ToGoIn" runat="server" Text="0"></asp:Label></h3>
                    <b>Use the form below to retrieve your forgotten email address.</b>
                    <br />
                    <br />
                    <h4>Phone Number:</h4>

                    <asp:Label ID="PhoneLabel" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#33CC33"></asp:Label>

                    <asp:TextBox ID="PhoneTextField" placeholder="Min. 8 Numeric Characters" pattern="[0-9]{8,8}$" title="Min. 8 Numeric Characters" required="required" MaxLength="8" Columns="30" runat="server"></asp:TextBox>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="RetrieveEmail" runat="server" Text="Submit Phone Number" OnClick="RetrieveEmail_Click" />
                </div>
            </div>
        </div>
