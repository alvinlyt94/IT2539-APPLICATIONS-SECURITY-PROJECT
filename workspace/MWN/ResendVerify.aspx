<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResendVerify.aspx.cs" Inherits="MWN.ResendVerify" %>
            ...
            <div class="container1">
                <div id="breadcrumb">
                    <ul>
                        ...
                        <li><a href="HomePage.aspx">Homepage</a></li>
                        <li>&#187;</li>
                        <li><a href="VerifyAccount.aspx">Verify Account</a></li>
                        <li>&#187;</li>
                        <li class="current"><a href="ResendVerify.aspx">Resend Verification Code</a></li>
                    </ul>
                </div>
                <br />
                <br />
                ...
                <div class="box">
                    <h3>Resend Verification Code.<asp:Label ID="ToGoIn" runat="server" Text="0"></asp:Label></h3>
                    <b>Use the form below to resend your new generated verifiation code.</b>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:Button ID="ResendVerificationCode" runat="server" Text="Submit Username" OnClick="ResendVerificationCode_Click" />
                    <br />
